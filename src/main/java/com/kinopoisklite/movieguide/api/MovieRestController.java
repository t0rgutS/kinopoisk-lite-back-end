...
public class MovieRestController {
    ...
    @PostMapping
    @Secured("ROLE_ADMIN")
    public ResponseEntity<Map> createMovie(@RequestBody MovieDTO request) {
        try {
            return ResponseEntity.ok().body(Collections.singletonMap("movie",
    ...
    public ResponseEntity<Map> updateMovie(@PathVariable String id, @RequestBody MovieDTO request) {
        try {
            return ResponseEntity.ok().body(Collections.singletonMap("movie",
